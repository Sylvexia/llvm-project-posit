...
APFloatBase::SemanticsToEnum(const llvm::fltSemantics &Sem) {
  ...
  else if (&Sem == &llvm::APFloat::Posit8Es0())
    return S_Posit8Es0;
  else if (&Sem == &llvm::APFloat::Posit16Es1())
    return S_Posit16Es1;
...
const fltSemantics &APFloatBase::Posit8Es0() { return semPosit8Es0; }
const fltSemantics &APFloatBase::Posit16Es1() { return semPosit16Es1; }
...
// @todo interface convert and init with apfloat

APInt IEEEFloat::convertPosit8Es0APFloatToAPInt() const {
  assert(partCount() == 1);
  return convertIEEEFloatToAPInt<semPosit8Es0>();
}
APInt IEEEFloat::convertPosit16Es1APFloatToAPInt() const {
  assert(partCount() == 1);
  return convertIEEEFloatToAPInt<semPosit16Es1>();
}
...
APInt IEEEFloat::bitcastToAPInt() const {
  ...
  if (semantics == (const llvm::fltSemantics *)&semPosit8Es0)
    return convertPosit8Es0APFloatToAPInt();

  if (semantics == (const llvm::fltSemantics *)&semPosit16Es1)
    return convertPosit16Es1APFloatToAPInt();
...
void IEEEFloat::initFromPosit8Es0APInt(const APInt &api) {
  initFromIEEEAPInt<semPosit8Es0>(api);
}

void IEEEFloat::initFromPosit16Es1APInt(const APInt &api) {
  initFromIEEEAPInt<semPosit16Es1>(api);
}
...
void IEEEFloat::initFromAPInt(const fltSemantics *Sem, const APInt &api) {
  ...
  if (Sem == &semPosit8Es0)
    return initFromPosit8Es0APInt(api);
  if (Sem == &semPosit16Es1)
    return initFromPosit16Es1APInt(api);
